...
const myWorks = [
  ...
  },
  {
    ...
    description:
      "Built a Currency Converter application that enables real-time currency conversions. Integrated APIs and implemented a user-friendly interface using React, JavaScript, and responsive design techniques",
  ...
  },
  {
    ...
    description:
      "Developed a Cryptocurrency Rate Tracker that provides real-time coin prices. Utilized React, API integration, and responsive design for a seamless user experience across all devices.",
